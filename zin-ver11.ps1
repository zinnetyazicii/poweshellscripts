...
$BtnKullanicilar.Location = New-Object System.Drawing.Point(($PictureBox.Location.X), ($PictureBox.Location.Y + $PictureBox.Height + 10)) # Y koordinatını biraz artır
...
$BtnGruplar.Location = New-Object System.Drawing.Point(($PictureBox.Location.X ), ($PictureBox.Location.Y + $PictureBox.Height + 10)) 
    ...
    if ($Username -ne "") {
        Try {
            ...
            if ($PwdLastSet) {
                ...
                $ListBox.Items.Add("📅 Şifre Değiştirme Tarihi: $($PwdLastSet.ToString('yyyy-MM-dd HH:mm'))")
            }
